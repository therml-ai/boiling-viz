...
class FixedTwoSlopeNorm(TwoSlopeNorm):
    def autoscale(self, A): pass
    def autoscale_None(self, A): pass
    def scaled(self): return True
...
class FieldBase:
    ...
    def min(self): return self.field.min()
    def max(self): return self.field.max()
    def timesteps(self): return self.field.shape[0]
